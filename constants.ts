...
export const WGT_CONTRACT_ADDRESS = "0x6e57A91229893fab9fFae1cE23e9939B0E2E68ce"; // 예: "0x1234567890abcdef1234567890abcdef12345678"

// 2. 여기에 Remix에서 복사한 ABI JSON 데이터를 붙여넣으세요.
// TypeScript에서 ABI의 타입을 명확히 하기 위해 'as const'를 붙여주는 것이 좋습니다.
export const WGT_CONTRACT_ABI = [
	{
		"inputs": [
			{
		...
		"name": "adjustBalanceAndRecordChallenge",
		"outputs": [],
